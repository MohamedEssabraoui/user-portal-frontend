...
class AddQuestionForm extends React.Component {
  ...
  componentDidMount() {
    const { subjectDetails, getSubjectDetails } = this.props;
    if (!subjectDetails || !subjectDetails.retrieved) {
      getSubjectDetails();
    }
  }
  ...
  render() {
     if(this.props.subjectDetails.retrived === false) {
      ...
      const subjectList = subjectDetails && subjectDetails.list ? subjectDetails.list : []; // Ensure list is defined
