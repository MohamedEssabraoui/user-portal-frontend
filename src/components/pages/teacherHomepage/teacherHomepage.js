...
import homeImg from '../../pages/teacherHP.webp';
...
class TeacherHomepage extends React.Component{
  constructor(props) {
    super(props);
    this.state = {
      content:(<div><img src={homeImg} alt="Logo" className={this.props.classes.homeimg}/></div>), // home - welcome message addquestion - add question form
      menuList : [{
        title:'Home',
        content:(<div><img src={homeImg} alt="Logo" className={this.props.classes.homeimg}/></div>)
      },{
        title: 'Add Question',
